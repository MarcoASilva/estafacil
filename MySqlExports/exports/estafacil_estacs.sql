...
--
-- Table structure for table `estacs`
--

DROP TABLE IF EXISTS `estacs`;
...
CREATE TABLE `estacs` (
  ...
  `coberto` int(11) DEFAULT NULL,
  `chaves` int(11) DEFAULT NULL,
  `pgto` varchar(45) DEFAULT NULL,
  `avalia` int(11) DEFAULT NULL,
  `idestab` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `estacs`
--

LOCK TABLES `estacs` WRITE;
